...
inCon.classList.add('mx-auto','max-w-2xl','sm:px-6','lg:max-w-7xl','lg:px-8');
con.appendChild(inCon);
//end inner container

//card
const card= document.createElement('div');
card.classList.add('mt-6','grid','grid-cols-1','gap-y-10','gap-x-6','sm:grid-cols-2','lg:grid-cols-4','xl:gap-x-8');
...
fetch(
  ...
  .then(function (data) {
    ...
    comics.forEach(hero => {
      ...
      imgCon.classList.add('min-h-80', 'aspect-w-1', 'aspect-h-1', 'w-full', 'overflow-hidden',
      ...
      img.classList.add('h-full', 'w-full', 'object-cover', 'object-center', 'lg:h-full', 'lg:w-full');
